...
--taskde belirtilen koşul gruplama gerektiren bir işlemden sonra ise GROUP BY dan sonra HAVING ile
--gruplama yapmadan yapılabilecek bir işlem ise GROUP BY dan önce WHERE ile oluşturulur.
...
--sadece tekrarsız veriler gösterir
